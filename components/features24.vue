            ...
            <h2 class="thq-heading-2">
              <slot name="feature1Title">
                ...
                <div class="features24-fragment3">
                  <span class="features24-text3">Artificial Intelligence</span>
                </div>
              </slot>
            </h2>
            <span class="thq-body-small">
              <slot name="feature1Description">
                ...
                <div class="features24-fragment6">
                  <span class="features24-text6">Cutting-edge AI solutions</span>
                </div>
              </slot>
            </span>
          </div>
            ...
            <h2 class="thq-heading-2">
              <slot name="feature2Title">
                ...
                <div class="features24-fragment1">
                  <span class="features24-text1">Machine Learning</span>
                </div>
              </slot>
            </h2>
            <span class="thq-body-small">
              <slot name="feature2Description">
                ...
                <div class="features24-fragment2">
                  <span class="features24-text2">Machine Learning Expertise</span>
                </div>
              </slot>
            </span>
          </div>
            ...
            <h2 class="thq-heading-2">
              <slot name="feature3Title">
                ...
                <div class="features24-fragment5">
                  <span class="features24-text5">IoT Services</span>
                </div>
              </slot>
            </h2>
            <span class="thq-body-small">
              <slot name="feature3Description">
                ...
                <div class="features24-fragment4">
                  <span class="features24-text4">Innovative IoT Solutions</span>
                </div>
              </slot>
            </span>
          </div>
...
export default {
  ...
  props: {
    ...
    feature1ImgSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1536179247184-595913ca4a28?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NDE3OTk0MHw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    feature2ImgAlt: {
      type: String,
    ...
    feature2ImgSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1667422380246-3bed910ffae1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NDE3OTk0MHw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    feature3ImgSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NDE3OTkzOXw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    feature3ImgAlt: {
      type: String,
      default: 'IoT Devices',
