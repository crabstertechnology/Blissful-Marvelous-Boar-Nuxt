          ...
          >
            <slot name="link1">
              ...
              <div class="footer4-fragment5">
                <span class="footer4-text18">Introduction</span>
              </div>
            </slot>
          </a>
          <a
          ...
          >
            <slot name="link2">
              ...
              <div class="footer4-fragment1">
                <span class="footer4-text14">Services</span>
              </div>
            </slot>
          </a>
          <a
          ...
          >
            <slot name="link4">
              ...
              <div class="footer4-fragment8">
                <span class="footer4-text21">Team</span>
              </div>
            </slot>
          </a>
          <a
          ...
          >
            <slot name="link5">
              ...
              <div class="footer4-fragment7">
                <span class="footer4-text20">Contact</span>
              </div>
            </slot>
          </a>
        </div>
            ...
            <span class="footer4-text11 thq-body-small">
              <slot name="privacyLink">
                ...
                <div class="footer4-fragment6">
                  <span class="footer4-text19">Privacy Policy</span>
                </div>
              </slot>
            </span>
            <span class="thq-body-small">
              <slot name="termsLink">
                ...
                <div class="footer4-fragment2">
                  <span class="footer4-text15">Terms of Service</span>
                </div>
              </slot>
            </span>
            <span class="thq-body-small">
