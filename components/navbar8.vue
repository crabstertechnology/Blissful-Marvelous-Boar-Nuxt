            ...
            <a :href="link1Url" class="navbar8-link12 thq-link thq-body-small">
              <slot name="link1">
                ...
                <div class="navbar8-fragment16">
                  <span class="navbar8-text20">#introduction</span>
                </div>
              </slot>
            </a>
            <a :href="link2Url" class="thq-link thq-body-small">
                ...
                <span class="thq-link thq-body-small">
                  <slot name="link4">
                    ...
                    <div class="navbar8-fragment17">
                      <span class="navbar8-text21">#team</span>
                    </div>
                  </slot>
                </span>
                    ...
                    <div class="navbar8-content1">
                      ...
                      <span class="thq-body-small">
                        <slot name="page1Description">
                          ...
                          <div>
                            <span>
                              Learn about Crabster Technology and our mission.
                            </span>
                          </div>
                        </slot>
                      </span>
                    ...
                    <div class="navbar8-content2">
                      ...
                      <span class="thq-body-small">
                        <slot name="page2Description">
                          ...
                          <div>
                            <span>Explore our AI, ML, and IoT services.</span>
                          </div>
                        </slot>
                      </span>
                    </div>
                    ...
                    <div class="navbar8-content3">
                      ...
                      <span class="thq-body-small">
                        <slot name="page3Description">
                          ...
                          <div>
                            <span>
                              Discover our innovative projects in EV and
                              agriculture.
                            </span>
                          </div>
                        </slot>
                    ...
                    <div class="navbar8-content4">
                      ...
                      <span class="thq-body-small">
                        <slot name="page4Description">
                          ...
                          <div>
                            <span>
                              Meet the talented individuals behind Crabster
                              Technology.
                            </span>
                          </div>
                        </slot>
              ...
              <span>
                <slot name="action1">
                  ...
                  <div class="navbar8-fragment12">
                    <span class="navbar8-text16">Get Started</span>
                  </div>
                </slot>
              </span>
            </button>
              ...
              <span>
                <slot name="action2">
                  ...
                  <div class="navbar8-fragment15">
                    <span class="navbar8-text19">Contact Us</span>
                  </div>
                </slot>
              </span>
            </button>
                ...
                <span class="navbar8-page12 thq-body-large">
                  <slot name="page1">
                    ...
                    <div class="navbar8-fragment20">
                      <span class="navbar8-text24">Introduction</span>
                    </div>
                  </slot>
                </span>
                <span class="thq-body-small">
                ...
                <span class="navbar8-page22 thq-body-large">
                  <slot name="page2">
                    ...
                    <div class="navbar8-fragment13">
                      <span class="navbar8-text17">Services</span>
                    </div>
                  </slot>
                </span>
                <span class="thq-body-small">
                  <slot name="page2Description">
                    ...
                    <div class="navbar8-fragment21">
                      <span class="navbar8-text25">
                        Explore our AI, ML, and IoT services.
                      </span>
                    </div>
                  </slot>
                </span>
                ...
                <span class="navbar8-page32 thq-body-large">
                  <slot name="page3">
                    ...
                    <div class="navbar8-fragment14">
                      <span class="navbar8-text18">Projects</span>
                    </div>
                  </slot>
                </span>
                <span class="thq-body-small">
                  <slot name="page3Description">
                    ...
                    <div class="navbar8-fragment23">
                      <span class="navbar8-text27">
                        Discover our innovative projects in EV and agriculture.
                      </span>
                    </div>
                  </slot>
                </span>
                ...
                <span class="navbar8-page42 thq-body-large">
                  <slot name="page4">
                    ...
                    <div class="navbar8-fragment10">
                      <span class="navbar8-text14">Team</span>
                    </div>
                  </slot>
                </span>
                <span class="thq-body-small">
                  <slot name="page4Description">
                    ...
                    <div class="navbar8-fragment19">
                      <span class="navbar8-text23">
                        Meet the talented individuals behind Crabster Technology.
                      </span>
                    </div>
                  </slot>
                </span>
...
export default {
  ...
  props: {
    ...
    page1ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1689443111384-1cf214df988a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NDE3OTkzOHw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    page3ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1541657000261-d7bd9adc2665?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NDE3OTkzOXw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    page4ImageAlt: {
      type: String,
      default: 'Team Image',
    ...
    page4ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1699200746675-8e4de41b9e08?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NDE3OTkzOXw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    page1ImageAlt: {
      type: String,
      default: 'Introduction Image',
    },
    logoAlt: {
      type: String,
      default: 'Crabster Technology Logo',
    },
    link1Url: {
      type: String,
      default: 'https://www.teleporthq.io',
    ...
    page2ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1615040727172-0da0f87dda4b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NDE3OTkzOXw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    logoSrc: {
      type: String,
      default:
